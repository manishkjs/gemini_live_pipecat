...
engineers. You get no abstraction tax and total control, but you personally own
...
is sufficient (see [Audio engineering](/gemini_live_pipecat/audio-engineering/)).
...
| **Text logging** | Requires transcription config | Transcripts are generated as pipeline artifacts |
