          ...
          switch (payload.type) {
              ...
              case "usage":
                  if (payload.usage) {
                      ...
                      // Report context compression if history exceeded the 4,500 threshold and dropped significantly (>1500 tokens)
                      if (this.lastPromptTokenCount >= 4500 && promptTokens < (this.lastPromptTokenCount - 1500)) {
