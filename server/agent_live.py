...
# Note: Tool schemas and async execution handlers are modularly defined in `tool_definitions.py`
...
async def run_agent_live(
    ...
    if context_compression:
        cwc["enabled"] = True
        cwc["trigger_tokens"] = context_compression_trigger_tokens if context_compression_trigger_tokens is not None else 5000
